...
namespace com.ataxlab.alfwm.mstests
{
    [TestClass]
    public class UnitTest1
    {
        ...
        //    var result = scheduler.StartActivity<HttpActivity, HttpActivityStatus, HttpActivityConfiguration>(activity, config).GetAwaiter().GetResult();
        //    int i = 0;
        }
